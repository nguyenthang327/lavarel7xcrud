...
@section('content')
    ...
    <form action="{{ url("/backend/product/store") }}" name="product" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="radio" name="product_status" id="product_status" value="2"> Tạm thời dừng bán
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="product_publish" class="form-control" id="product_publish" style="width: 250px" value="{{ old('product_publish',"") }}">
        </div>

        <div class="form-group">
            <label for="product_quantity">Tồn kho sản phẩm:</label>
            <input type="number" name="product_quantity" class="form-control" id="product_quantity" style="width: 250px" value="{{ old('product_quantity',"") }}">
        </div>

        <div class="form-group">
            <label for="product_price">Giá sản phẩm:</label>
            <input type="text" name="product_price" class="form-control" id="product_price" style="width: 250px" value="{{ old('product_price',"") }}">
        </div>
